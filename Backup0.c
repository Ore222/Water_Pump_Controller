...
#define _pumppausetime 900  // pump pause time (seconds) when well water is low
#define _pumppausedelay 120	// pump pause monitoring delay approximate time (seconds)
